...
import styles from "../styles/HomePageStyles/LeadershipSection.module.scss";

const LeadershipSection = () => {
  const { t } = useTranslation("common");
  const members = t("leadership.members", { returnObjects: true }) as Array<{
    image: string;
    name: string;
    role: string;
    description: string;
  ...
  return (
    <section className={styles.leadership}>
      ...
      <button className={styles.ctaButton}>{t("leadership.cta")}</button>
    </section>
  );
};
