...
import styles from "../../styles/AboutPageStyles/CybersecuritySpecialists.module.scss";

const CybersecuritySpecialistsSection = () => {
  const { t } = useTranslation("about");
  const members = t("cybersecuritySpecialists.members", { returnObjects: true }) as Array<{
    image: string;
    name: string;
    role: string;
    description: string;
  ...
  return (
    <section className={styles.cybersecuritySpecialists}>
      <h2>{t("cybersecuritySpecialists.title")}</h2>
      <div
      ...
      <button className={styles.ctaButton}>{t("cybersecuritySpecialists.cta")}</button>
    </section>
  );
};
