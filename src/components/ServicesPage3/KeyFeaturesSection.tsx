...
const KeyFeatures = () => {
  ...
  const keyFeatures = t("page3.keyFeatures", { returnObjects: true }) as Array<{
    title: string;
    description: string;
  }>;

  const overviewTitle = t("page3.overviewTitle");
  const overviewText = t("page3.overviewText");

  const tdrTitle = t("page3.tdrTitle");
  const tdrText = t("page3.tdrText");

  const bestPracticesTitle = t("page3.bestPracticesTitle");
  const bestPractices = t("page3.bestPractices", { returnObjects: true }) as Array<{
    title: string;
    description: string;
  }>;

  const conclusionTitle = t("page3.conclusionTitle");
  const conclusionText = t("page3.conclusionText");
  ...
  return (
    <section className={styles.keyFeaturesSection}>
      ...
      <div className={styles.iconContainer}>
        <img src="/images/card-icon3.png" alt="Icon" className={styles.icon} />
      </div>
